    ...
    public class InitializerToSeedDataForMarketContext : DropCreateDatabaseIfModelChanges<MaintenanceContext>
    {
        protected override void Seed(MaintenanceContext context)
        {
            ...
            var productlist = new[] {   new Product
                ...
                {
                    MaxQuantity = 2,
                    Category = category,Description=@"Pantalla LED 7 (1024x600). Proc.Intel Atom SoFia 3G-R. SO Android 5.1. Memoria int. 8Gb- RAM 1Gb. Slot p/micro SD h/32Gb. Cámara post. 2.0Mp- frontal 0.3Mp. Video integrado h/1080p. Wi-Fi. Bluetooth. Micro USB. Bateria Li-Polymero 3.7V 3000mAh. Name=TABLET PC J14",ProductionStart=DateTime.Now, IsAvailable=true
                },
                new Product
                {
                    MaxQuantity = 10,
                    Category = category,Description=@"Sistema Operativo Windows 10 - Pantalla 19,5 HD 1600x900 Bright Display - Procesador Intel Pentium 4ta generación - Memoria 4 GB DDR3 SODIMM 1600 MHZ - Unidad , Name=COMPUTADORA AIO E19-I2",ProductionStart=DateTime.Now, IsAvailable=true
                },
                new Product
                {
                    MaxQuantity = 5,
