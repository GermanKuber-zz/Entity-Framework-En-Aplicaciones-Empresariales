...
namespace Market.Data
{
    ...
    public class InitializerToSeedDataForMarketContext : DropCreateDatabaseAlways<MarketContext>
    {
        protected override void Seed(MarketContext context)
        {
            ...
            var productlist = new[] {   new Product {Description=@"PANTALLA 13.3 Full HD (1920x1080) | MEMORIA RAM 4GB | ALMACENAMIENTO 128GB SSD | BATERIA Li-ion, 4 celdas, 4125mAh (Integrada) | CERFITICACION AMBIENTAL ENERGY STAR 6.1| TECLADO Retroiluminado | AUDIO Intel HD Audio Micrófono Mono Integrado | GRÁFIC Name=NOTEBOOK VAIO PRO 13G",ProductionStart=DateTime.Now, IsAvailable=true },
                                        new Product {Description=@"Pantalla LED 7 (1024x600). Proc.Intel Atom SoFia 3G-R. SO Android 5.1. Memoria int. 8Gb- RAM 1Gb. Slot p/micro SD h/32Gb. Cámara post. 2.0Mp- frontal 0.3Mp. Video integrado h/1080p. Wi-Fi. Bluetooth. Micro USB. Bateria Li-Polymero 3.7V 3000mAh. Name=TABLET PC J14",ProductionStart=DateTime.Now, IsAvailable=true },
                                        new Product {Description=@"Sistema Operativo Windows 10 - Pantalla 19,5 HD 1600x900 Bright Display - Procesador Intel Pentium 4ta generación - Memoria 4 GB DDR3 SODIMM 1600 MHZ - Unidad , Name=COMPUTADORA AIO E19-I2",ProductionStart=DateTime.Now, IsAvailable=true },
                                        new Product {Description=@"Procesador Intel Core i5 | Gráficos Nvidia Gforce GV-N950OC-2GD | Motherboard Gigabyte H110 | Memoria 8GB DDR4 2133MHz HyperX | Fuente Thermaltake TR2 600W", Name="PC GAMER GM-Y 950 I5",ProductionStart=DateTime.Now, IsAvailable=true },
                                        new Product {Description=@"Procesador Intel Core i7 | Gráficos Nvidia Gforce GV-N970IX-4GD | Motherboard Gigabyte H170 Gaming 3 | Disco 2TB 7200RPM + HDD SSD 240GB | Realtek ALC1150, 5.1", Name="PC GAMER GM-Y970 I7",ProductionStart=DateTime.Now, IsAvailable=true },
                                        new Product {Description=@"SAMSUNG J7 2016 NEGRO J710 LIb", Name="CELULAR LIBRE GALAXY J7 2016 NEGRO",ProductionStart=DateTime.Now, IsAvailable=true }
                                    };
            ...
            context.SaveChanges();
            context.Customers.AddRange(new[] { mariano, martin, juanMiron });
